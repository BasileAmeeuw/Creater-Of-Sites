...
![picture alt](https://github.com/BasileAmeeuw/Creator-of-Sites/blob/master/Image/Clone.gif "How to clone on github" {width=40px height=400px})
* Then you clone it in the right repository in your computer.
![picture alt](https://github.com/BasileAmeeuw/Creator-of-Sites/blob/master/Image/Wamp.gif "How to clone on your computer" {width=40px height=400px})
